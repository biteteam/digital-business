              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <img
                    ...
                    src="<?= base_url('assets/admin/dist/img/user1-128x128.jpg') ?>"
                ...
                <div class="direct-chat-msg right">
                  ...
                  <img
                    class="direct-chat-img"
                    src="<?= base_url('assets/admin/dist/img/user3-128x128.jpg') ?>"
                    alt="message user image"
                  />
                  <!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
                ...
                <ul class="contacts-list">
                  ...
                  <li>
                    <a href="#">
                      <img
                        class="contacts-list-img"
                        src="<?= base_url('assets/admin/dist/img/user7-128x128.jpg') ?>"
                        alt="User Avatar"
                      />
                  ...
                  <li>
                    <a href="#">
                      <img
                        class="contacts-list-img"
                        src="<?= base_url('assets/admin/dist/img/user5-128x128.jpg') ?>"
                        alt="User Avatar"
                      />
                  ...
                  <li>
                    <a href="#">
                      <img
                        class="contacts-list-img"
                        src="<?= base_url('assets/admin/dist/img/user6-128x128.jpg') ?>"
                        alt="User Avatar"
                      />
                  ...
                  <li>
                    <a href="#">
                      <img
                        class="contacts-list-img"
                        src="<?= base_url('assets/admin/dist/img/user8-128x128.jpg') ?>"
                        alt="User Avatar"
                      />
