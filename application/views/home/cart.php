...
<div class="container-fluid pt-5">
    <div class="row px-xl-5">
            ...
            <div class="col-lg-3">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <form action="<?= base_url("/order/payment-state") ?>" method="post">
                            <input type="hidden" id="payment-result" name="payment-result" value="<?= base64_encode(json_encode($carts)) ?>">
        ...
        <?php else : ?>
            <div class="w-100 d-flex flex-column justify-content-center align-items-center py-5 my-5">
                <h1>Belum ada apapun di keranjangmu</h1>
                <a href="<?= base_url("/#product") ?>" class="btn btn-primary my-3 py-3 px-4 font-weight-semi-bold text-lg rounded-lg">Mulai Belanja Sekarang</a>
            </div>
        <?php endif ?>
