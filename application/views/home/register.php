    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form">
                <div id="success"></div>
                <form name="register" id="registerForm" method="post" action="<?= base_url('auth/register-action') ?>">
                    <div class="control-group">
                        <input type="text" class="form-control" id="name" name="namaKonsumen" placeholder="Nama Lengkap" required="required" data-validation-required-message="Please enter your name" />
                    ...
                    <div class="control-group">
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" data-validation-required-message="Please enter your email" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
                    ...
                    <div>
                        <button class="btn btn-primary py-2 px-4" type="submit" id="register">Register</button>
                    </div>
                </form>
            </div>
        </div>
